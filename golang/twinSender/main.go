...
func main() {
	...
	log.Printf("Created Twin %s", twinMotionSensorIdentity.Did())
				...
				Args: &ioticsApi.SendInputMessageRequest_Arguments{
					Interest: &ioticsApi.InputInterest{
						...
						DestInputId: &ioticsApi.InputID{
							Id:     twinsFound[0].GetInputs()[0].InputId.Id,
							TwinId: twinsFound[0].TwinId.Id,
							HostId: twinsFound[0].TwinId.HostId,
						},
					},
				},
