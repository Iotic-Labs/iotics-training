...
def main():
    ...
    ### 5. CREATE TWIN SYNTHESISER IDENTITY WITH CONTROL DELEGATION
    ...
    ### 7. CREATE DIGITAL TWIN TERMOSTAT
    ...
    ### 9. SEARCH FOR TWIN TEMPERATURE SENSOR
    twins_found_list = []
    payload = iotics_api.get_search_payload(
        text="LP",
        properties=[
        ...
        try:
            ...
            if message != previous_message_sent:
                iotics_api.send_input_message(
                    sender_twin_did=twin_thermostat_identity.did,
